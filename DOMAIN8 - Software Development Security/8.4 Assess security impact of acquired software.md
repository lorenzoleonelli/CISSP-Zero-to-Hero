...
🔗 Here you find the theory of trust boundary: [1.10 Understand and apply threat modeling concepts and methodologies](../DOMAIN1%20-%20Security%20and%20Risk%20Management/1.10%20Understand%20and%20apply%20threat%20modeling%20concepts%20and%20methodologies.md)
...
🔗 See also [1.11 Apply supply chain risk management (SCRM) concepts](../DOMAIN1%20-%20Security%20and%20Risk%20Management/1.11%20Apply%20supply%20chain%20risk%20management%20(SCRM)%20concepts.md)
...
>⚠ Just because a product is commercially supported doesn’t mean it’s securely configured out of the box
...
One of the great promises of open source is **transparency**. Unlike commercial software, `you’re not locked out of the source code`. In theory, anyone can inspect it, test it, fix it, and contribute to improving it. This is often described as “*many eyes make all bugs shallow*”—the idea that with enough skilled people looking at the code, vulnerabilities are more likely to be discovered and resolved quickly. But that’s a romanticized view. 

> ⚠In reality, most open source projects are maintained by a small group of volunteers or underfunded developers. Just because code is open doesn't mean anyone is actively auditing it. 

*The infamous Heartbleed vulnerability in OpenSSL lived quietly for years in the code, despite being open for all to see. It wasn’t patched because no one was looking—until it was too late.*

> ℹ Assessing the security impact of open source starts with understanding who maintains the project. Is it backed by a known organization, like the Apache Software Foundation or the Linux Foundation? Or is it a side project run by a single person in their spare time? This matters, because your security posture now depends on their responsiveness to bugs, their willingness to fix vulnerabilities, and their discipline around version control.
...
> ℹ  Some open source software comes with viral licenses like the GNU GPL, which may force you to open your own source code if you integrate their work. That’s not just a legal issue; it becomes a security and governance risk if ignored.
...
> ⚠ Just like with COTS, never assume with open source that "it works" means "it's safe."
...
A[Third-Party Software Security Assessment] --> B[Discovery]
A --> C[Risk Analysis]
A --> D[Integration Review]
A --> E[Patch & Update Management]
A --> F[Legal & Contractual Controls]
A --> G[Continuous Lifecycle Monitoring]

%% Discovery
B --> B1[Shadow IT visibility problem]
B --> B2[Build inventory of SaaS, apps, APIs, plugins]
B --> B3[Use asset mgmt + endpoint monitoring]
B --> B4[Principle: You can't secure what you can't see]

%% Risk Analysis
C --> C1[Vendor reputation & maturity]
C --> C2[Security posture: ISO 27001, audits, pentests]
C --> C3[Data exposure & breach impact]
C --> C4[Accountability & logging access]

%% Integration Review
D --> D1[APIs, SSO, data flows]
D --> D2[SAML / OAuth2 support]
D --> D3[MFA & access restrictions]
D --> D4[SIEM logging integration]
D --> D5[Data types: PII, financial, IP]

%% Patch & Updates
E --> E1[Vendor-dependent patching]
E --> E2[Delay between vulnerability & fix]
E --> E3[Vendor disclosure & response speed]
E --> E4[Temporary compensating controls]

%% Legal & Contracts
F --> F1[Security clauses in contracts]
F --> F2[Breach notification SLAs]
F --> F3[Data protection & encryption rules]
F --> F4[Audit rights & termination clauses]
F --> F5[Regulatory compliance: GDPR, HIPAA]

%% Continuous Lifecycle
G --> G1[Pre-adoption assessment]
G --> G2[Implementation review]
G --> G3[Ongoing monitoring]
G --> G4[Employee awareness & shadow IT control]
G --> G5[Security as enabler, not blocker]
```
...
🔗 SaaS, PaaS and IaaS where first described in 3.5.6:[3.5 Assess and mitigate the vulnerabilities of security architectures, designs and solution elements](../DOMAIN3%20-%20Security%20Architecture%20and%20Engineering/3.5%20Assess%20and%20mitigate%20the%20vulnerabilities%20of%20security%20architectures,%20designs%20and%20solution%20elements.md)
