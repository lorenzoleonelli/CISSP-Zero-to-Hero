...
> ⚠ Whether it's from a form, a cookie, a URL parameter, or an API call, every input should be validated and sanitized appropriately.
...
> ⚠  APIs are often consumed by machines, not humans, so the abuse can be automated, relentless, and invisible—until it’s too late.
...
> ⚠  Never return more data than the minimum necessary. Follow the principle of least privilege in your responses. Map outputs tightly to each role and function.
