...
graph LR
    ...
    style WL fill:#d3d3d3,stroke:#333,stroke-width:2px,color:#000 style AS fill:#f0f0f0,stroke:#333,stroke-width:2px,color:#000 style Threat fill:#333,color:#fff,stroke-width:2px style Defense fill:#666,color:#fff,stroke-width:2px style User fill:#fff,stroke:#000,stroke-width:2px
...
![onboarding|697](https://github.com/user-attachments/assets/e70f8b7d-46cc-411a-a850-619b5bb8ec78)
