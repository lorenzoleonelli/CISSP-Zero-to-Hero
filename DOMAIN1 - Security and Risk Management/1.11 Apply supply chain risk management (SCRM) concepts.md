...
> ⚠ The ultimate goal of a secure supply chain is to guarantee that the final product meets quality, performance, and security standards without any compromise or unauthorized manipulation throughout the process. However, the supply chain itself can pose a threat vector, as materials, software, hardware, or data obtained from trusted sources may have been compromised or manipulated maliciously.

>🔗 Refer also to 1.3.2 Organizational Processes: [1.3 Evaluate, apply, and sustain security governance principles](1.3%20Evaluate,%20apply,%20and%20sustain%20security%20governance%20principles.md)
...
> ℹ Since it is hardware-based, RoT it is considered highly resistant to tampering or attacks compared to software-based trust mechanisms.
