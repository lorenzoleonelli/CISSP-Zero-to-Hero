...
> 🔗 Refer also to 3.9.9 in [3.9 Design site and facility security controls](../DOMAIN3%20-%20Security%20Architecture%20and%20Engineering/3.9%20Design%20site%20and%20facility%20security%20controls.md)
...
| Device | The "Vibe" | What it actually does | CISSP Layer (OSI) |
| :--- | :--- | :--- | :--- |
| **Amplifier** | The Megaphone | Boosts signal power (and noise) to travel further. | Layer 1 (Physical) |
| **Repeater** | The Regenerator | Cleans and rebuilds the signal to extend reach. | Layer 1 (Physical) |
| **Hub** | The Gossip | Blindly broadcasts data to *everyone* on the port. | Layer 1 (Physical) |
| **Concentrator** | The Funnel | Combines multiple signals into one for WAN efficiency. | Layer 1 (Physical) |
| **Bridge** | The Link | Connects two LAN segments; filters by MAC address. | Layer 2 (Data Link) |
| **Switch** | The Traffic Cop | Intelligently sends data *only* to the intended MAC address. | Layer 2 (Data Link) |
| **Access Point** | The Bridge-less | Connects wireless clients to the wired "mothership." | Layer 2 (Data Link) |
| **Router** | The GPS | Connects different networks using IP addresses. | Layer 3 (Network) |
| **Gateway** | The Translator | Connects networks with *different* protocols/architectures. | Layer 7 (Application) |
| **Proxy** | The Intermediary | Stands in the middle for security, caching, and privacy. | Layer 7 (Application) |
...
> ℹ Physical NAC solutions are typically deployed within the network infrastructure to control access to physical network resources, such as switches, routers, and firewalls. These solutions use hardware components and physical mechanisms to control who can connect to the network.
...
> 🔗 Zero Trust is described in detail in 3.1.8 in [3.1 Research, implement, and manage engineering processes using secure design principles](../DOMAIN3%20-%20Security%20Architecture%20and%20Engineering/3.1%20Research,%20implement,%20and%20manage%20engineering%20processes%20using%20secure%20design%20principles.md)
