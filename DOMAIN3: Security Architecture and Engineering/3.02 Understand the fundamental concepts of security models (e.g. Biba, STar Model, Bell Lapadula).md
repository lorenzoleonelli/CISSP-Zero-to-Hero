...
stateDiagram-v2
    ...
    [*] --> Unclassified
    Unclassified --> Confidential : read (✔)\nwrite (❌)
    Confidential --> Unclassified : read (❌)\nwrite (✔)

    Confidential --> Secret : read (✔)\nwrite (❌)
    Secret --> Confidential : read (❌)\nwrite (✔)

    Secret --> TopSecret : read (✔)\nwrite (❌)
    TopSecret --> Secret : read (❌)\nwrite (✔)
