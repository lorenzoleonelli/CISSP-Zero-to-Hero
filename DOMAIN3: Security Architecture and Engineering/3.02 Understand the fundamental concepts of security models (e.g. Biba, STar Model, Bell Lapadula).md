...
flowchart TD
    ...
    subgraph "Enforcement - Before"
        CE1[User]
        CE2[CDI: Financial Report]
    end

    subgraph "Enforcement - After"
        CE1a[User]
        CE3[T.P.: ApproveReport]
        CE2a[CDI: Financial Report]
        CE1a -->|calls| CE3
        CE3 -->|writes| CE2a
    end

    subgraph "Separation of Duties - Before"
        SD1[Clerk]
        SD2[Manager]
        SD3[T.P.: ApprovePayment]
        SD4[CDI: PaymentData]
    end

    subgraph "Separation of Duties - After"
        SD1a[Clerk]
        SD2a[Manager]
        SD3a[Certified T.P.]
        SD4a[CDI: PaymentData]
        SD1a -->|initiates| SD3a
        SD2a -->|authorizes| SD3a
        SD3a -->|executes| SD4a
    end
