...
stateDiagram-v2
    ...
    [*] --> Unclassified
    Unclassified --> Confidential : read (✔) / write (❌)
    Confidential --> Unclassified : read (❌) / write (✔)

    Confidential --> Secret : read (✔) / write (❌)
    Secret --> Confidential : read (❌) / write (✔)

    Secret --> TopSecret : read (✔) / write (❌)
    TopSecret --> Secret : read (❌) / write (✔)
