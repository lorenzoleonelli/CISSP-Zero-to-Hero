...
:link: This section of Domain 6 is focused on audit design, refer to section [6.5 Conduct or facilitate security audits](https://github.com/lorenzoleonelli/CISSP-Zero-to-Hero/blob/main/DOMAIN6%3A%20Security%20Assessment%20and%20Testing/6.5%20Conduct%20or%20facilitate%20security%20audits.md#650-preface) to better learn how to implement them.
...
:necktie: One key challenge with internal audits is the potential for **conflict of interest**. When someone reviews a process they helped design or manage, it’s difficult to be completely objective.
...
```mermaid
%%{init: {"theme": "base", "themeVariables": {"primaryColor": "#ffffff", "secondaryColor": "#f2f2f2", "primaryTextColor": "#000000", "lineColor": "#000000"}}}%%
mindmap
  root((SOC Reports))
    SOC 1
      Purpose
