...
1. **Authentication** is the process (happening right after Identification) of verifying the identity of a user, device, or system. It ensures that the entity attempting to gain access is who they claim to be.
Think of authentication like different ways to convince the system that you’re the real person.
...
:brain: Easy to use, easy to steal.
...
:brain: If someone steals the device, the factor is compromised — unless it’s locked by another factor.
...
:brain: These are convenient but can’t be changed if compromised.
...
:brain: Useful for stopping remote or foreign attacks.
...
:brain: Often used in continuous authentication. And usually considered Type 3 (Something you are) authentication methods.
...
:brain: If something looks “off,” the system increases verification requirements.
...
:bulb: Interested in biometrics ? The table below is for you:
