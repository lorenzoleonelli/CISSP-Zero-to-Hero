...
> 🔗 Refer also to 1.2.1 in [1.2 Understand and apply security concepts](../DOMAIN1%20-%20Security%20and%20Risk%20Management/1.2%20Understand%20and%20apply%20security%20concepts.md)
...
> ⚠ **Deprovisioning vs Decommissioning.**
...
> ⚠ IAM really has become the new perimeter — not because we chose it, but because the old perimeter simply vanished. With cloud, SaaS, remote work, and APIs everywhere, the network edge dissolved… but identity didn’t. Today the “front door” isn’t a firewall. It’s the moment someone authenticates.

![IAAA](https://github.com/user-attachments/assets/77af9689-bf07-4e4a-8d11-24cfd6abec30)

How will **AI** impact the world of Identity and Access Management ?

1. **The Rise of the "Non-Human" Workforce**: AI is shifting the focus of IAM from managing human users to governing semi-autonomous AI agents, requiring us to treat these "synthetic identities" with the same lifecycle rigor, least privilege, and accountability as any employee.
2. **From Static Policies to Behavioral Fluidity**: We are moving away from rigid, "Boolean-logic" access rules toward Adaptive Risk Models where AI analyzes real-time telemetry—such as typing biometrics and intent—to continuously verify trust rather than relying on a single point-in-time login.
3. **The Hyper-Automated Arms Race**: While AI enables "Identity Threat Detection and Response" (ITDR) to neutralize anomalies at machine speed, it simultaneously empowers adversaries to execute high-fidelity deepfake impersonations and automated credential stuffing, making phishing-resistant MFA a non-negotiable baseline
