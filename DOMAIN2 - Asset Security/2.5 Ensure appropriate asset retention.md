...
```mermaid
flowchart TB
    A["<b>Retention Policy Roadmap</b>"]

    subgraph Strategy ["1. Strategy & Compliance"]
    B["Purpose & Scope"] --- B1["Defines objectives and<br/>systems covered"]
    C["Legal & Regulatory Alignment"] --- C1["Ensures compliance with<br/>laws and rules"]
    end

    subgraph Operations ["2. Data Operations"]
    D["Data Categorization"] --- D1["Sets retention periods<br/>per data type"]
    E["Secure Handling"] --- E1["Mandates secure management<br/>and destruction"]
    F["Litigation Exception"] --- F1["Outlines handling during<br/>litigation (Legal Hold)"]
    end

    subgraph Governance ["3. Lifecycle & Training"]
    G["Roles & Responsibilities"] --- G1["Assigns responsibility to<br/>individuals or teams"]
    H["Training & Awareness"] --- H1["Educates employees on<br/>policy requirements"]
    I["Regular Review"] --- I1["Schedules periodic review<br/>and adaptation"]
    end
    ...
    class B1,C1,D1,E1,F1,G1,H1,I1 node
```
...
🔗 [NIST SP 800-92](https://csrc.nist.gov/pubs/sp/800/92/final) seeks to assist organizations in understanding the need for sound computer security log management
