...
flowchart TD
    ...
    B --> C{"On-premise Backup:<br/>Geographical Separation?"}
    
    C -->|Too Close| D["Risk: Both hit by same disaster<br/>(e.g., same building)"]
    C -->|"Sufficient distance<br/>(e.g., >25-100 miles)"| E[Backup safe from same event]
    
    E --> F["Improved Disaster Recovery"]
    ...
    class A,C,J,H center
    class B,D,E,F,G,I node
```
