...
The most common standards that apply to wiring closets are:
...
> ℹ When designing a data center, focus on ensuring enough space, power, and cooling for current and future needs, while also planning for security, redundancy, and disaster recovery. It's important to meet industry standards, keep energy efficiency in mind, and ensure the network is reliable and scalable. Proper budgeting and planning for both immediate and long-term operations are key to making the data center efficient and secure.

> ℹ Server rooms and data centers are increasingly adopting virtualization and cloud technologies to increase flexibility and scalability. By virtualizing servers and storage, organizations can reduce hardware dependency and more efficiently allocate resources, ensuring that systems can scale with the needs of the business. Additionally, as data security becomes more critical, encryption, access controls, and monitoring tools are integrated into the data center infrastructure to ensure data protection against cyber threats.
...
🔗 Review [2.2 Establish information and asset handling requirements](../DOMAIN2%20-%20Asset%20Security/2.2%20Establish%20information%20and%20asset%20handling%20requirements.md)
...
> 🔗 Refer also to 7.1.1 in [7.01 Understand and comply with investigations](../DOMAIN7%20-%20Security%20Operations/7.01%20Understand%20and%20comply%20with%20investigations.md)

> ⚠ You should consult a lawyer when dealing with evidence storage to ensure compliance with legal and regulatory requirements, especially regarding data privacy, chain of custody, and retention periods.
...
> ⚠ We must not only be aware of environmental risks but also assess their potential impact on critical assets and manage them proactively through a structured Business Continuity strategy
...
🔗 Refer also to [1.7 Identify, analyze, assess, prioritize, and implement Business Continuity (BC) requirements](../DOMAIN1%20-%20Security%20and%20Risk%20Management/1.7%20Identify,%20analyze,%20assess,%20prioritize,%20and%20implement%20Business%20Continuity%20(BC)%20requirements.md)
...
> ℹThe most common fire suppression systems include water-based (sprinklers), gas-based (FM-200, CO₂, Inergen), dry chemical (potassium-based for kitchens), and foam-based (for fuel fires). In data centers and server rooms, clean agent systems like FM-200 or Novec 1230 are preferred as they suppress fire without damaging electronic equipment.
...
> ℹ The most common types of Uninterruptible Power Supply (UPS) systems are:
...
Power Security Summary Table:

| Component                 | Purpose                                         | Key Characteristics                                                          | CISSP Focus Area                   |
| :------------------------ | :---------------------------------------------- | :--------------------------------------------------------------------------- | :--------------------------------- |
| **Redundant Power**       | Eliminates **Single Points of Failure (SPOF)**. | Uses multiple grids, dual power supplies, and diverse routing.               | **Availability** & Fault Tolerance |
| **UPS Systems**           | Provides **immediate**, short-term power.       | Bridges the gap between utility failure and generator startup.               | Data Integrity (Safe shutdowns)    |
| **Backup Generators**     | Provides **long-term** power support.           | Usually diesel-powered; requires fuel management and load testing.           | Business Continuity (BCP)          |
| **Physical Layout**       | Protects power infrastructure.                  | Secure locations, environmental protection (flood/fire), and access control. | Physical Security & Safety         |
| **Maintenance & Testing** | Ensures **operational readiness**.              | Routine load testing, fuel checks, and battery replacement cycles.           | Operational Security               |

Comparison of UPS Types:

| UPS Type                       | Protection Level | Mechanism                                                                   | Best Use Case                                |
| :----------------------------- | :--------------- | :-------------------------------------------------------------------------- | :------------------------------------------- |
| **Standby (Offline)**          | Basic            | Switches to battery only during an outage or major fluctuation.             | Home offices or non-critical workstations.   |
| **Line-Interactive**           | Moderate         | Uses an **Automatic Voltage Regulator (AVR)** to handle minor fluctuations. | Small server racks and network equipment.    |
| **Online (Double-Conversion)** | **Highest**      | Always runs on battery; zero switchover time ($0ms$) between sources.       | Critical data centers and medical equipment. |
