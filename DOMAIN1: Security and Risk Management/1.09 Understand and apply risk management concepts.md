...
:link: [NIST SP 800-30r1](https://csrc.nist.gov/pubs/sp/800/30/r1/final) provides a list of threat categories, concepts and examples 
...
flowchart TD
  ...
  Decision --> Avoidance["Avoidance\n— cease risky activity\n- opportunity cost"]
  Decision --> Transfer["Transfer\n— share risk - e.g. insurance"]
  Decision --> Mitigation["Mitigation\n— implement controls to reduce risk"]
...
flowchart LR
    ...
    E --> G["Collect metrics pre- and post-control"]
    F --> G
